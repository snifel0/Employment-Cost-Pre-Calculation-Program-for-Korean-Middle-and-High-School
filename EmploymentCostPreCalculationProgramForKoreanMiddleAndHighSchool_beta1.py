...
if __name__ == "__main__":
    ...
    employeelist_treeview = ttk.Treeview(root, columns=('id','성명'), show="headings")
    ...
    employeelist_treeview.column(0, width=20)
    ...
    employee_search_name_label.place(x=0, y=250)
    ...
    employee_search_name_entry.place(x=50, y=250)
    ...
    employee_absence_label.place(x=100, y=75)
    ...
    employee_absence_category_box.place(x=140, y=75)
    employee_absence1_year_label = Label(root, text="년")
    employee_absence1_year_label.place(x=210+90+5, y=75)
    ...
    employee_absence1_year_box.place(x=160+90+5, y=75)
    employee_absence1_month_label = Label(root, text="월")
    employee_absence1_month_label.place(x=270+80+5, y=75)
    ...
    employee_absence1_month_box.place(x=230+85+5, y=75)
    ...
    employee_absence1_day_label.place(x=330+70+5, y=75)
    ...
    employee_absence1_day_box.place(x=290+75+5, y=75)
    employee_absence2_year_label = Label(root, text="~")
    employee_absence2_year_label.place(x=350-5+75, y=75)
    employee_absence2_year_label = Label(root, text="년")
    employee_absence2_year_label.place(x=420-5+70, y=75)
    ...
    employee_absence2_year_box.place(x=370-5+70, y=75)
    employee_absence2_month_label = Label(root, text="월")
    employee_absence2_month_label.place(x=480-5+60, y=75)
    ...
    employee_absence2_month_box.place(x=440-5+65, y=75)
    ...
    employee_absence2_day_label.place(x=540-5+50, y=75)
    ...
    employee_absence2_day_box.place(x=500-5+55, y=75)

    employee_contigous_label = Label(root, text='원로교사')
    employee_contigous_label.place(x=530, y=50)
    ...
    employee_contigous_radiobtn1.place(x=600,y=75)
    ...
    employee_contigous_radiobtn2.place(x=635,y=75)
    ...
    employee_absence_pushbtn.place(x=100,y=100)
    ...
    employee_absence_pullbtn.place(x=100,y=130)
    ...
    employee_absence_applybtn.place(x=100,y=160)
    ...
    employee_absence_treeview.place(x=140, y=100)


    employee_appointment_label = Label(root, text="현부서임용일")
    employee_appointment_label.place(x=510-470, y=350)
    employee_appointment_year_label = Label(root, text="년")
    employee_appointment_year_label.place(x=610-440, y=350)
    ...
    employee_appointment_year_box.current(0)
    employee_appointment_year_box.place(x=560-440, y=350)
    employee_appointment_month_label = Label(root, text="월")
    employee_appointment_month_label.place(x=665-440, y=350)
    ...
    employee_appointment_month_box.current(0)
    employee_appointment_month_box.place(x=630-440, y=350)
    ...
    employee_appointment_day_label.place(x=720-440, y=350)
    ...
    employee_appointment_day_box.current(0)
    employee_appointment_day_box.place(x=685-440, y=350)

    employee_retire_label = Label(root, text="퇴직일")
    employee_retire_label.place(x=510-200, y=350)
    employee_retire_year_label = Label(root, text="년")
    employee_retire_year_label.place(x=610-200, y=350)
    ...
    employee_retire_year_box.current(0)
    employee_retire_year_box.place(x=560-200, y=350)
    employee_retire_month_label = Label(root, text="월")
    employee_retire_month_label.place(x=665-200, y=350)
    ...
    employee_retire_month_box.current(0)
    employee_retire_month_box.place(x=630-200, y=350)
    ...
    employee_retire_day_label.place(x=720-200, y=350)
    ...
    employee_retire_day_box.current(0)
    employee_retire_day_box.place(x=685-200, y=350)
    ...
    employee_career_label.place(x=0, y=75+300-10)
    ...
    employee_career_category_entry.place(x=40, y=75+300)
    ...
    employee_career_position_entry.place(x=140, y=75+300)
    ...
    employee_career_publicbtn1.place(x=200+50,y=75+300)
    ...
    employee_career_publicbtn2.place(x=240+50,y=75+300)
    ...
    employee_career_rate_entry.place(x=350, y=75+300)
    employee_career_label = Label(root, text="%")
    employee_career_label.place(x=380, y=75+300)
    employee_career1_year_label = Label(root, text="년")
    employee_career1_year_label.place(x=210+80+90+80+5, y=75+300)
    ...
    employee_career1_year_box.place(x=160+80+90+80+5, y=75+300)
    employee_career1_month_label = Label(root, text="월")
    employee_career1_month_label.place(x=270+80+80+80+5, y=75+300)
    ...
    employee_career1_month_box.place(x=230+80+85+80+5, y=75+300)
    ...
    employee_career1_day_label.place(x=330+80+70+80+5, y=75+300)
    ...
    employee_career1_day_box.place(x=290+80+75+80+5, y=75+300)
    employee_career2_year_label = Label(root, text="~")
    employee_career2_year_label.place(x=350+80+75+80, y=75+300)
    employee_career2_year_label = Label(root, text="년")
    employee_career2_year_label.place(x=420+80+70+80, y=75+300)
    ...
    employee_career2_year_box.place(x=370+80+70+80, y=75+300)
    employee_career2_month_label = Label(root, text="월")
    employee_career2_month_label.place(x=480+80+60+80, y=75+300)
    ...
    employee_career2_month_box.place(x=440+80+65+80, y=75+300)
    ...
    employee_career2_day_label.place(x=540+80+50+80, y=75+300)
    ...
    employee_career2_day_box.place(x=500+80+55+80, y=75+300)
    ...
    employee_career_pushbtn.place(x=0,y=100+300)
    ...
    employee_career_pullbtn.place(x=0,y=130+300)
    ...
    employee_career_applybtn.place(x=0,y=160+300)
    ...
    employee_career_treeview.place(x=40, y=100+300)

    employee_elder_candidate_text = Text(root, width = 103, height = 5)
    employee_elder_candidate_text.place(x=40, y=540)
    ...
    def 본봉표(연도, 근속가봉표={}):
        url = 'http://www.mpm.go.kr/mpm/info/resultPay/bizSalary/'+str(연도)
        html = urlopen(url)
    ...
    ## 명절월은 꼭 추석, 설 당일이 포함 된 월로 지정하여 계산할 것.
    class 급여생성:
        본봉표 = None
        def __init__(self, 교직원, 작업연도, 명절월=[9,13]):
            self.교직원 = 교직원
            self.명절월 = 명절월
        ...
        def 교직수당가산금1(self, 원로교사수당):
            ...
            추가근무연한일수 = (working_month-self.strptime(self.교직원["현근무년수변경일"])).days+1
            근무연수 = int((근무연한일수 - 비공무원경력일수 + 추가근무연한일수)//365)
            if self.교직원["원로교사"] == 0 and 만나이 >= 55 and 근무연수 >= 30:
    ...
    employee_working_year_label.place(x=645, y=60+35)
    ...
    employee_working_year_box.place(x=645,y=85+35)
    ...
    def create_salary(salary_creation):
        ...
        try:
            salary_creation.차기본봉표 = 본봉표(작업연도+1, 근속가봉표)
        except:
            pass
    salary_creation_btn = Button(root, text="작업연도 급여생성", command=lambda: create_salary(급여생성))
    salary_creation_btn.place(x=645,y=280+35-170)
    ...
    def calculate_salary_table(employeelist):
        ...
        급여목록 = [급여생성(employee, 작업연도) for employee in employeelist]
        for 급여 in 급여목록:
            salarytables = []
    ...
    salary_calculation_btn.place(x=645,y=310+35-170)
    ...
    def save_salary_table(급여목록):
        ...
        for 급여 in 급여목록:
            ...
            for r in dataframe_to_rows(df, index=True, header=True):
                ws.append(r)
            ws.append([])
        wb.save(f"salarytable_{작업연도}_{datetime.now().strftime('%Y-%m-%d-%H%M%S')}.xlsx")
        showinfo("저장", "완료되었습니다!")
    salary_save_table_btn = Button(root, text="작업연도 급여저장", command=lambda: save_salary_table(급여목록))
    salary_save_table_btn.place(x=645,y=340+35-170)
    ...
    salary_save_table_btn.place(x=645,y=370+35-170)
    ##############  Code   ###############
    ...
    salary_load_employeelist_btn.place(x=645,y=400+35-170)
    ...
    salary_save_employeelist_btn.place(x=645,y=430+35-170)
